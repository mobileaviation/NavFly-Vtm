...
public enum AirspaceCategory {
    ...
    C (Color.DKGRAY, 30, Color.TRANSPARENT ,20, 0x70E4A19E ,0, true, true),
    CTR (Color.DKGRAY, 30, Color.TRANSPARENT ,20, 0x70E4A19E ,0, true, true),
    ...
    TMA (Color.BLACK, 0, 0xFF7C6D92,3, Color.TRANSPARENT, 8, false, true),
    ...
    PROHIBITED (Color.RED, 8, 0xFFFBA642, 15, 0x10FBA642, 7, true, true),
